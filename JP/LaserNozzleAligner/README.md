...
この度は ノズル芯出し検査器 をご購入いただきありがとうございます。<br>

本マニュアルには、製品仕様や操作手順、保守および注意事項などの重要な情報を記載しています。ご使用前に本マニュアルをよくお読みください。
...
- 使用温度範囲（0～50 ℃）を超える環境で使用しないでください。
- 水がかかる環境で使用しないでください。
- 本製品を投げたり落としたり、硬い物で圧迫したりしないでください。
- 本製品を無断で分解・改造しないでください。
- 使用後は電源をOFFにしてください。
- 保管時はスライドカバーを閉じ、保護レンズへの汚れやほこりの付着を防いでください。
- 導電性または腐食性のある液体を付着させないでください。
...
<table class="warranty-table">
  ...
  <tr>
    ...
    <td class="center" rowspan="3">弊社での預かり修理</td>
...
- 標準保証は、製品の取扱説明書や注意事項に従って正常に使用したにもかかわらず、製品に故障・不具合が生じた場合を対象とします。お客様の過失により故障・不具合が生じた場合は、有償での対応となります。
- 製品のメンテナンスおよびクリーニングは、お客様ご自身で行っていただきます。
- 弊社スタッフがお客様のもとへ訪問して行う修理・メンテナンスは実施しておりません。
- 製品に故障・不具合が発生した場合、状況確認のため、写真や動画をご提供いただく必要があります。
- 保証期間は、製品がお客様のもとへ到着した日を起算日とします。
- 標準保証期間終了後の検査及び修理作業費は、1 時間あたり 4,000 円 ( 税別 ) となります。

<div class="subheading">免責事項について</div>
...
| 精度 | < 0.08 mm |
| 重量 | 480 g（バッテリー含む） |
| 外形寸法 | 83 mm（長さ）× 83 mm（幅）× 71 mm（高さ） |
| 電源 | 外部電源（8.4 V / 1 A）または内蔵バッテリー（14500 × 2） |
...
[3.2.1 装置の位置合わせ](#321-装置の位置合わせ)の手順を確認し、保護スライドカバーが開いていることをご確認ください。<br>
また、「カメラOFF」をクリックした場合は「ノズル撮影」ボタンをクリックしてカメラを起動してください。
