...
- TCP通信: plugin_tcp 0.0 ***TODO**
使用するプラグインを選択した状態で「設定」ボタンを
...
手動トリガー有効
マーク画面に「手動トリガー」ボタンを表示します。
連続加工時に

シリアル番号のリセット
マーク画面に「シリアル番号リセット」ボタンを表示します。


可変テキストのリアルタイム保存
可変テキスト要素が刻印された場合、更新した文字列がすぐに保存されます。


リアルタイム更新

連続マーキング時、時刻テキストなどの刻印結果をすぐにプレビュー画面に反映します。
